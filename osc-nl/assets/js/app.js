...
ROUTES.convocatorias = function(){
  ...
  return H('<div class="page"><div class="wrap">',
    ...
    '<p class="psub">Doce años de convocatorias del Programa de Fomento, con su estado y sus resultados. ',
      'Cada una con su estado, su fecha de cierre y sus documentos.</p>',
    demo, hist,
...
ROUTES.fortalecimiento = function(){
  ...
  return H('<div class="page"><div class="wrap">',
    ...
    '<p class="psub">Guías, marco normativo y el boletín del sector, reunidos y clasificados ',
      'por tipo de documento.</p>',
    ...
    'Cada volumen con su número y su periodo.</p>',
    '<div class="vosces">',
...
ROUTES.contacto = function(){
  return H('<div class="page"><div class="wrap">',
    ...
    '<p class="psub">Quién atiende, por qué medio y en cuánto tiempo responde.</p>',
    '<div class="grid2">',
